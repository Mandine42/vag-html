...
// 		this.#droit = this.#component.querySelector("#fleche-droite");
// 		this.#gauche = this.#component.querySelector("#fleche-gauche");
...
// 	#addDroit = (e) => {
// 		this.#droit.addEventListener("click", (e) => {
// 			if (this.#i < this.#img.length - 1) {
// 				this.#i++;
// 				const imagePath = `asset/img-caroussel/${this.#img[this.#i]}`;
// 				// console.log("Changement de l'image vers :", imagePath); // Pour débogage
...
// 	#addGauche = (e) => {
// 		this.#gauche.addEventListener("click", (e) => {
// 			if (this.#i > 0) {
// 				this.#i--;
// 				const imagePath = `asset/img-caroussel/${this.#img[this.#i]}`;
// 				// console.log("Changement de l'image vers :", imagePath); // Pour débogage
...
// const img = new Caroussel("#carrousel");
class Caroussel {
    // Propriétés privées
    #img = [
        "ton quartier.svg",
    ...
    #addSwipeEvents = () => {
        this.#component.addEventListener("touchstart", this.#handleTouchStart, false);
